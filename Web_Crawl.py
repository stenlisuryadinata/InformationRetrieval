...
# -*- coding: utf-8 -*-
"""
Created on Fri Mar 18 06:22:58 2022
...
stopwords = ['the', 'of', 'and', 'to', 'in', 'you', 'it', 'with', 'that', 'or', 'was', 'he', 'is', 'for', 'this', 'his', 'as', 'not', 'at', 'by', 'all', 'they', 'but', 'be', 'on', 'from', 'had', 'her',
'work', 'are', 'any', 'she', 'if', 'said', 'so', 'which', 'have', 'do', 'we', 'no', 'my', 'were', 'them', 'their', 'him', 'one', 'will', 'me', 'there', 'who', 'up', 'other', 'an', 'its',
'when', 'what', 'can', 'may', 'into', 'out', 'must', 'your', 'then', 'would', 'could', 'more', 'now', 'has', 'like', 'down', 'where', 'been', 'through', 'did', 'away', 'these',
'such', 'set', 'back', 'some', 'than', 'way', 'made', 'our', 'after', 'well', 'should', 'get', 'even', 'am', 'go', 'saw', 'just', 'put', 'while', 'ever', 'off', 'here', 'also']
...
class PorterStemmer:
    ...
    def step2(self):
        ...
        if self.b[self.k - 1] == 'a':
            ...
            if self.ends("logi"):
                self.r("log")
            # To match the published algorithm, dele
...
if __name__ == '__main__':
    ...
    #
    con = sqlite3.connect("/Users/stenlisuryadinata/webcrawler.db")
...
#
        ...
        cur.execute("insert into DocumentDictionary values ('%s', '%s')" % (documents, crawling))
        ...
        if links_queue < 500:
            ...
            for link in (links.pop(0) for x in range(len(links))):
                if link.startswith('/'):
